...
if __name__ == "__main__":
    ...
    raw_file = os.path.join(datasets_dir, "upi_dataset.csv")
    ...
    if "isFraud" in df.columns:
        df_processed["isFraud"] = df["isFraud"].values
        
    # We also need nameOrig and nameDest for feature engineering
    for col in ["step", "nameOrig", "nameDest"]:
        if col in df.columns:
            df_processed[col] = df[col].values
            
    output_file = os.path.join(datasets_dir, "upi_dataset_preprocessed.csv")
